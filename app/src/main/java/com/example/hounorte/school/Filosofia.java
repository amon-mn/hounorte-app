...
public class Filosofia extends AppCompatActivity {
    ...
    private void updateQuestion(){
        total++;
        if(total>1){
            Intent in = new Intent(Filosofia.this, Resultados.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("module").child("4").child("Filosofia").child("questions").child(String.valueOf(total));
