...
public class Fisica extends AppCompatActivity {
    ...
    private void updateQuestion(){
        total++;
        if(total>1){
            Intent in = new Intent(Fisica.this, Resultados.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("module").child("8").child("Fisica").child("questions").child(String.valueOf(total));
