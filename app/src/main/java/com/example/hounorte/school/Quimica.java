...
public class Quimica extends AppCompatActivity {
    ...
    private void updateQuestion(){
        total++;
        if(total>1){
            Intent in = new Intent(Quimica.this, Resultados.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("module").child("10").child("Quimica").child("questions").child(String.valueOf(total));
