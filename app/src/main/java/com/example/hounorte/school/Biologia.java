...
public class Biologia extends AppCompatActivity {
    ...
    private void updateQuestion(){
        total++;
        if(total>1){
            Intent in = new Intent(Biologia.this, Resultados.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("module").child("9").child("Biologia").child("questions").child(String.valueOf(total));
