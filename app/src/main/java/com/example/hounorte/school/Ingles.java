...
public class Ingles extends AppCompatActivity {
    ...
    private void updateQuestion(){
        total++;
        if(total>1){
            Intent in = new Intent(Ingles.this, Resultados.class);
            ...
            reference = FirebaseDatabase.getInstance().getReference().child("module").child("6").child("Ingles").child("questions").child(String.valueOf(total));
